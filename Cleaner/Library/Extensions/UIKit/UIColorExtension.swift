...
extension UIColor {
    ...
    /**
     CleanerAppsLibrary: Create dynamic color for light and dark user interface style.
    ...
    /**
     CleanerAppsLibrary: Create color for interface levels.
    ...
    /**
     CleanerAppsLibrary: Create color by HEX.
    ...
    /**
     CleanerAppsLibrary: Tint color for first window.
    ...
    /**
     CleanerAppsLibrary: Get HEX from current color.
     */
    ...
    /**
     CleanerAppsLibrary: Color with new opacity.
    ...
    /**
     CleanerAppsLibrary: Make color lighter.
    ...
    /**
     CleanerAppsLibrary: Make color darker.
    ...
    /**
     CleanerAppsLibrary: Mix with other color.
    ...
    /**
     CleanerAppsLibrary: Convert HEX to RGB channels.
    ...
    /**
     CleanerAppsLibrary: List of colorful colors.
     */
    #if !os(watchOS)
    ...
    /**
     CleanerAppsLibrary: Color of footnote label.
     */
    #if !os(watchOS) && !os(tvOS)
    ...
    /**
     CleanerAppsLibrary: Wrapper of destructive actions color.
     */
    #if !os(watchOS)
    ...
    /**
     CleanerAppsLibrary: Wrapper of warning actions color.
     */
    #if !os(watchOS)
    ...
    /**
     CleanerAppsLibrary: New color to system stack.
    ...
    /**
     CleanerAppsLibrary: New color to system grouped stack.
