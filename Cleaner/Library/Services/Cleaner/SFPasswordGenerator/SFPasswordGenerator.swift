...
public class SFPasswordGenerator {
    // MARK: Privatr Properties
    
    public static let shared = SFPasswordGenerator()
    ...
    public func generateBasicPassword() -> SFPasswordModel {
    ...
    /// - Returns: Сгенерированный пароль
    public func generateComplexPassword() -> SFPasswordModel {
    ...
    public func generatePassword(includeNumbers: Bool = true, includeLetters: Bool = true, includeSymbols: Bool = true, length: Int = 16) -> SFPasswordModel {
        ...
        let secureLevel: SFPasswordModel.SecureLevel = {
...
public extension SFPasswordGenerator {
