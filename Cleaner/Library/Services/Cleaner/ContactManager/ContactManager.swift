...
/// Если контакты в секретном хранилище были изменены, то отправистя нотификация  `NotificationRelay.contactStorageUpdated`
class ContactManager: NSObject {
    ...
    private var contactCreateVCCallbacks: [CNContactViewController:ContactCallback] = [:]
    private var contactPickerVCCallbacks: [CNContactPickerViewController:ContactCallback] = [:]
    private var contactPreviewVCCallbacks: [CNContactViewController:VoidCallback] = [:]
    ...
    /// - Returns: Контакты
    func getAll() -> [ContactReplicaScannerViewType] {
    ...
    func save(_ newContact: ContactReplicaScannerViewType) -> Bool {
        ...
        NotificationRelay.send(event: .contactStorageUpdated)
        return true
    }
    ...
    func save(_ newContacts: [ContactReplicaScannerViewType]) -> Bool {
    ...
    func delete(_ contactForDeliting: ContactReplicaScannerViewType) -> Bool {
        var existingContacts = contacts
    ...
    func delete(_ contactsForDeliting: [ContactReplicaScannerViewType]) -> Bool {
        var existingContacts = contacts
    ...
    func createContactController(didCompleteCallback: ContactCallback? = nil) -> CNContactViewController  {
    ...
    func chooseFromNotebookController(didCompleteCallback: ContactCallback? = nil) -> CNContactPickerViewController {
    ...
    func getNativeContactController(for contact: ContactReplicaScannerViewType, didCompleteCallback: VoidCallback? = nil) -> CNContactViewController?  {
...
extension ContactManager: CNContactViewControllerDelegate {
    func contactViewController(_ viewController: CNContactViewController, didCompleteWith contact: CNContact?) {
        
        let sfContact: ContactReplicaScannerViewType?
...
extension ContactManager: CNContactPickerDelegate {
    ...
    func contactPicker(_ picker: CNContactPickerViewController, didSelect contact: CNContact) {
        let sfContact: ContactReplicaScannerViewType = .init(cnContact: contact, phoneKit: phoneNumberKit)
        temporaryContacts.append(contact)
